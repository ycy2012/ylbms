...
<!--
	function addTr(value) {
		...
		for ( var i = 0, len = value.length; i < len; i++) {
			...
			myTD4.innerHTML = "<input type='text'  value="+temp[4]+"> <input type='hidden'  name='singles["+j+"].state' value="+temp[6]+">";
			var myTD5 = myTR.insertCell(4);
			myTD5.innerHTML = "<input type='text' name='singles["+j+"].remark' > <input type='hidden' name='singles["+j+"].location.wzId' value="+temp[5]+">";
