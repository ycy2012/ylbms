...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		  ...
		  <shiro:hasPermission name="base:jmb:add">
		   ...
		   <li class="line">line</li>
			...
			<shiro:hasPermission name="base:jmb:edit">
			<li><a class="edit" href="${ctx}/jmbinfo/editUi/{sdjId_jd}" target="dialog" mask="true" title="修改精密表信息"><span>修改</span></a></li>
			<li class="line">line</li>
			</shiro:hasPermission>
			<shiro:hasPermission name="base:jmb:add">
			<li><a class="edit" href="${ctx}/jmbinfo/importUi"
				target="dialog" mask="true" title="导入单件信息"><span>EXCEL导入</span></a></li>
				<li class="line">line</li>
			</shiro:hasPermission>
			<li><a class="icon" href="${ctx}/jmbinfo/export" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
		    <li class="line">line</li>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach items="${page.result}" var="acc">
				...
				<td><input name="djIds" value="'${acc.jmbID}'" type="checkbox"></td>
					...
					--%>
				<td>
				<shiro:hasPermission name="base:jmb:delete">
