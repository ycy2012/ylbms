...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${ctx}/dict/list"
		method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>名称：<input type="text" name="filter_LIKES_fullname"
						value="${param['filter_LIKES_fullname']}" /></td>
					<td>状态：</td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/dict/addUi" target="dialog"
				mask="true" title="添加字典信息"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids"
				postType="string" href="${ctx}/dict/delByIds" class="delete"><span>批量删除</span></a></li>
			<li><a class="edit" href="${ctx}/dict/editUi/{sid_dict}"
				target="dialog" mask="true" title="修改字典信息"><span>修改</span></a></li>
		...
		<tbody>
			<c:forEach items="${page.result}" var="acc">
				<tr target="sid_dict" rel="${acc.id}">
					...
					<td><a title="删除字典信息" target="ajaxTodo"
						href="${ctx}/dict/delete/${acc.id}" class="btnDel">删除字典信息</a> <a
						title="编辑字典信息" target="dialog" href="${ctx}/dict/editUi/${acc.id}"
						class="btnEdit">编辑字典信息</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
